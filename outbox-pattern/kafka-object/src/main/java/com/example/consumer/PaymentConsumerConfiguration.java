...
import static com.example.KafkaConstants.PAYMENT_CONSUMER_COMPENSATION_CONTAINER_NAME;
...
public class PaymentConsumerConfiguration {
    ...
    @Bean(PAYMENT_CONSUMER_CONTAINER_NAME)
    ...
    @Bean(PAYMENT_CONSUMER_COMPENSATION_CONTAINER_NAME)

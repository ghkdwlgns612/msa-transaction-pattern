...
import static com.example.kafka.KafkaConstants.PAYMENT_CONSUMER_CONTAINER_NAME;
import static com.example.kafka.KafkaConstants.PAYMENT_DLQ_TEMPLATE_NAME;
import static com.example.kafka.KafkaConstants.PAYMENT_TOPIC_NAME;
...
public class OrderConsumer {
    ...
    public void listener(OrchestratorToPaymentRequest request) {
